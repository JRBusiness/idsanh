...
from server.shared.helpers.ppocr.utils.e2e_metric.Deteval import get_socre_A, get_socre_B, combine_results
from server.shared.helpers.ppocr.utils.e2e_utils.extract_textpoint_slow import get_dict
