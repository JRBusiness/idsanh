...
from server.shared.helpers.ppocr.utils.stats import TrainingStats
from server.shared.helpers.ppocr.utils.save_load import save_model
from server.shared.helpers.ppocr.utils.utility import print_dict, AverageMeter
from server.shared.helpers.ppocr.utils.logging import get_logger
from server.shared.helpers.ppocr.utils.loggers import VDLLogger, WandbLogger, Loggers
from server.shared.helpers.ppocr.utils import profiler
from server.shared.helpers.ppocr.data import build_dataloader
...
def preprocess(is_train=False):
    config = load_config(cfg.kie_config)
